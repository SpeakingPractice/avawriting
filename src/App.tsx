...
const DEFAULT_MYDU_LOGO = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 160" width="160" height="160"><circle cx="80" cy="80" r="76" fill="%231b365d" stroke="%23f59e0b" stroke-width="7"/><circle cx="80" cy="80" r="70" fill="%230284c7"/><circle cx="80" cy="80" r="69" fill="%230284c7" stroke="%23ffea00" stroke-width="2"/><path d="M 42 82 C 22 56, 42 24, 64 16 C 47 26, 35 56, 42 82 Z" fill="%23ffffff" opacity="0.95"/><g fill="%23ffea00"><path d="M 60 23.5 l 1.3 2.7 h 2.9 l -2.3 2.2 l 0.9 2.9 l -2.8 -1.8 l -2.8 1.8 l 0.9 -2.9 l -2.3 -2.2 h 2.9 z"/><path d="M 71 23.5 l 1.3 2.7 h 2.9 l -2.3 2.2 l 0.9 2.9 l -2.8 -1.8 l -2.8 1.8 l 0.9 -2.9 l -2.3 -2.2 h 2.9 z"/><path d="M 82 23.5 l 1.3 2.7 h 2.9 l -2.3 2.2 l 0.9 2.9 l -2.8 -1.8 l -2.8 1.8 l 0.9 -2.9 l -2.3 -2.2 h 2.9 z"/><path d="M 93 23.5 l 1.3 2.7 h 2.9 l -2.3 2.2 l 0.9 2.9 l -2.8 -1.8 l -2.8 1.8 l 0.9 -2.9 l -2.3 -2.2 h 2.9 z"/><path d="M 104 23.5 l 1.3 2.7 h 2.9 l -2.3 2.2 l 0.9 2.9 l -2.8 -1.8 l -2.8 1.8 l 0.9 -2.9 l -2.3 -2.2 h 2.9 z"/></g><g><path d="M 42 82 L 56 44 L 70 82 H 60 L 56 68 H 50 L 47 82 Z" fill="%23ffea00" stroke="%23ffea00" stroke-width="2" stroke-linejoin="round"/><polygon points="56,49 52,58 60,58" fill="%230284c7"/><path d="M 76 82 L 90 44 L 104 82 H 94 L 90 68 H 84 L 80 82 Z" fill="%23ffea00" stroke="%23ffea00" stroke-width="2" stroke-linejoin="round"/><polygon points="90,49 86,58 94,58" fill="%230284c7"/><path d="M 61 44 L 73 82 L 85 44" fill="none" stroke="%23ffffff" stroke-width="7.5" stroke-linecap="round" stroke-linejoin="round"/></g><rect x="20" y="88" width="120" height="18" rx="3" fill="%230284c7"/><text x="80" y="102" font-family="'Arial Black', 'Impact', system-ui, sans-serif" font-weight="900" font-size="11" fill="%23ffffff" text-anchor="middle" letter-spacing="0.2">ANH NGỮ MỸ DU</text><path d="M 28 106 C 50 148, 110 148, 132 106 C 118 142, 42 142, 28 106 Z" fill="%23ffea00"/><circle cx="120" cy="118" r="15" fill="%232563eb" stroke="%23ffffff" stroke-width="2.5"/><path d="M 112 118 L 117 123 L 128 112" fill="none" stroke="%23ffffff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>`;
