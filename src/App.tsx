...
const DEFAULT_MYDU_LOGO = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 160" width="160" height="160"><circle cx="80" cy="80" r="76" fill="%231b365d" stroke="%23f59e0b" stroke-width="7"/><circle cx="80" cy="80" r="70" fill="%230284c7"/><circle cx="80" cy="80" r="69" fill="%230284c7" stroke="%23facc15" stroke-width="2"/><path d="M 34 82 C 32 46, 58 24, 112 34 C 70 28, 42 48, 34 82 Z" fill="%23ffffff" opacity="0.95"/><g fill="%23facc15"><path d="M 52 38 l 2 4 h 4 l -3 3 l 1 4 l -4 -2 l -4 2 l 1 -4 l -3 -3 h 4 z"/><path d="M 66 31 l 2 4 h 4 l -3 3 l 1 4 l -4 -2 l -4 2 l 1 -4 l -3 -3 h 4 z"/><path d="M 80 27 l 2 4 h 4 l -3 3 l 1 4 l -4 -2 l -4 2 l 1 -4 l -3 -3 h 4 z"/><path d="M 94 31 l 2 4 h 4 l -3 3 l 1 4 l -4 -2 l -4 2 l 1 -4 l -3 -3 h 4 z"/><path d="M 108 38 l 2 4 h 4 l -3 3 l 1 4 l -4 -2 l -4 2 l 1 -4 l -3 -3 h 4 z"/></g><g transform="translate(5, 0)"><path d="M 45 82 L 58 45 L 72 82 H 63 L 58 68 H 51 L 47 82 Z M 53 60 H 57 L 55 52 Z" fill="%23facc15" stroke="%23facc15" stroke-width="2.5" stroke-linejoin="round"/><path d="M 68 82 L 82 45 L 96 82 H 87 L 82 68 H 75 L 71 82 Z M 77 60 H 81 L 79 52 Z" fill="%23facc15" stroke="%23facc15" stroke-width="2.5" stroke-linejoin="round"/><path d="M 58 45 L 68 82 L 82 45" fill="none" stroke="%23ffffff" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/></g><rect x="20" y="88" width="120" height="18" rx="3" fill="%230284c7"/><text x="80" y="102" font-family="'Arial Black', 'Impact', system-ui, sans-serif" font-weight="900" font-size="11" fill="%23ffffff" text-anchor="middle" letter-spacing="0.2">ANH NGỮ MỸ DU</text><path d="M 28 106 C 50 148, 110 148, 132 106 C 118 142, 42 142, 28 106 Z" fill="%23facc15"/><circle cx="120" cy="118" r="15" fill="%232563eb" stroke="%23ffffff" stroke-width="2.5"/><path d="M 112 118 L 117 123 L 128 112" fill="none" stroke="%23ffffff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>`;
